...
- Menyederhanakan proses *onboarding* guru agar lebih cepat.

### 3. Keamanan & Kebersihan Data
- **Middleware**: Menambahkan proteksi ketat sehingga user belum aktif hanya bisa melihat halaman tunggu.
- **Penyaringan Statistik**: Seluruh statistik tetap hanya menghitung pengguna yang sudah disetujui (aktif).
- **Tab Pending**: Admin memiliki daftar khusus untuk akun "asing" atau belum disetujui untuk segera disetujui atau dihapus.
