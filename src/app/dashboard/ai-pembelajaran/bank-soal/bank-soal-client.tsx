...
export default function BankSoalClient({ 
    ...
    }, [initialQuestions, searchTerm, filterClass, filterSubject]);
                ...
                <AnimatePresence mode="popLayout">
                    {filteredQuestions.length > 0 ? (
                                    ...
                                    <div className="p-6 sm:p-8 flex flex-col md:flex-row gap-6">
                                        ...
                                        <div className="flex-1 space-y-6">
                                            ...
                                            <div className="pt-4 border-t border-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                                ...
                                                <Button variant="link" className="text-indigo-600 font-black text-[10px] uppercase tracking-widest h-auto p-0 hover:no-underline group/link">
                                                    Lihat Pembahasan Lengkap
                                                    <ChevronDown className="h-3 w-3 ml-1 group-hover/link:translate-y-0.5 transition-transform" />
                                                </Button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="py-32 text-center flex flex-col items-center">
                            ...
                            {searchTerm && (
                                <Button variant="link" onClick={() => {setSearchTerm(""); setFilterClass("all"); setFilterSubject("all");}} className="mt-4 text-indigo-600 font-bold">
                                    Bersihkan Filter
                                </Button>
                            )}
                        </div>
