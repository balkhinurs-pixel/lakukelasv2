...
export default function PromotionPageClient({ classes }: { classes: Class[] }) {
    return (
                        ...
                        <div className="flex items-center gap-4 flex-wrap">
                            <div className="flex-1 space-y-1 min-w-[180px]">
                                ...
                                <Select>
                                    ...
                                    <SelectContent>
                                        {classes.filter(c => c.name.startsWith("Kelas 12") || c.name.startsWith("XII")).map(c => <SelectItem key={c.id} value={c.id}>{c.name}</SelectItem>)}
                                    </SelectContent>
                                </Select>
                            </div>
