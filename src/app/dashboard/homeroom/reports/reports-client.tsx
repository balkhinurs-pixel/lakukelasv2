  ...
  return (
    <div className="space-y-8 p-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 px-2">
            ...
            <div className="flex items-center gap-3 p-4 rounded-3xl bg-amber-50 border border-amber-100">
            ...
            <div className="flex items-center gap-3 p-4 rounded-3xl bg-red-50 border border-red-100">
