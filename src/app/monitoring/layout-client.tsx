        ...
        <SidebarHeader className="p-0 text-background">
          <div className="relative flex flex-col items-center gap-2 bg-gradient-to-br from-teal-600 via-teal-600 to-cyan-500 p-6 group-data-[collapsible=icon]:hidden overflow-hidden">
              ...
              <Avatar className="h-20 w-20 border-4 border-white/30 shadow-2xl shadow-black/20 transition-transform duration-300 hover:scale-105 hover:border-white/50 relative z-10">
                ...
                <AvatarFallback className="text-foreground bg-white/20 backdrop-blur-sm">{profile?.full_name?.charAt(0) || 'K'}</AvatarFallback>
              </Avatar>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent className="rounded-3xl border-0 shadow-2xl">
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>Anda akan keluar dari panel monitoring.</AlertDialogDescription>
                        </AlertDialogHeader>
            ...
            <div className="flex items-center justify-between h-16 px-4">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent className="rounded-3xl border-0 shadow-2xl">
                        <AlertDialogHeader>
                          <AlertDialogTitle>Keluar Monitoring?</AlertDialogTitle>
                          <AlertDialogDescription>Apakah Anda ingin keluar dari panel monitoring?</AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter className="flex flex-row gap-2 pt-4">
                          <AlertDialogCancel className="flex-1 rounded-xl h-12">Batal</AlertDialogCancel>
                          <AlertDialogAction onClick={handleLogout} className="flex-1 rounded-xl h-12 bg-red-600 font-bold">Keluar</AlertDialogAction>
